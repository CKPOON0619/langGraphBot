...
from tweetingBot.twitter_chains import generation_chain, reflection_chain, evaluation_chain
...
def improve_tweet(tweet: str) -> str:
    inputs = HumanMessage(content=f"Make this tweet better: {tweet}")
    response: List[BaseMessage] = reflection_graph.invoke(inputs)
...
if __name__ == '__main__':
  ...
  improved_tweet = improve_tweet(original_tweet)
