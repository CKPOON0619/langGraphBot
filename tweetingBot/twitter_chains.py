...
class TweetGeneration(BaseModel):
    tweet: str = Field(description="The generated or revised tweet")

def extract_tweet(result: TweetGeneration) -> str:
    return result.tweet
...
generation_chain = generation_prompt | hot_ollama_llm 
